...
public class Bar {
    ...
    /**
     * true if this is the first bar in the piece
     */
    public final boolean isFirst;

    /**
     * true if this is the last bar in the piece
     */
    ...
    Bar(long nativePointer, int idx,  int dur, int seqi, boolean ci, boolean fi, boolean la) {
