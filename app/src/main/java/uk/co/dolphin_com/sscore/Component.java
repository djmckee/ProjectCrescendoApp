...
public class Component
{
	...
	public static enum Type 
	{
		...
		direction_text, direction_dynamics, direction_pedal, direction_metro, direction_reh, direction_segnocoda,
		notation_slur, notation_tied, notation_slide, notation_glissando, notation_tuplet,
		direction_wedge, direction_dashes, _direction_bracket, direction_oshift,
		...
		harmony, harmony_frame, repeat_brace, multiple, parent, undefined
	};
